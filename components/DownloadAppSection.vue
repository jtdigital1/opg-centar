  ...
  <section class="py-120px">
    <div class="max-w-[1280px] mx-auto px-12">
      <div class="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
        <div class="">
          <h1 class="text-4xl md:text-4xl lg:text-5xl xl:text-5xl font-semibold pb-6">Lorem Ipsum is simply dummy text of the printing and.</h1>
          ...
          <div class="flex flex-col sm:flex-row gap-2">
            <a href="#" class="flex gap-2 items-center bg-green py-3 px-8 rounded-full justify-center">
